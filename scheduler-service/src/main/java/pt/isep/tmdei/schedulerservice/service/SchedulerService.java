...
public class SchedulerService {
        ...
        public ScheduleDeliveryResponseDTO scheduleDelivery(ScheduleDeliveryRequestDTO request) {
                ...
                var createDeliveryResponse = deliveryServiceClient.createDelivery(request.getUsername(),
                                request.getPickupCoordinates(), request.getDropOffCoordinates()).getBody();
                ...
                var transportation = transportationService
                                .scheduleDeliveryTransport(createDeliveryResponse.getDeliveryId());

                var response = new ScheduleDeliveryResponseDTO(request.getUsername(),
                                createDeliveryResponse.getDeliveryId(), createPackageResponse.getPackageId(),
                                createDeliveryResponse.getStatus(), createDeliveryResponse.getCreated());
